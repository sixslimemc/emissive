...
execute if score *pt.depth _emissive matches 1.. if score *pt.level _emissive matches 1.. if entity @n[type=marker,distance=..16,tag=_emissive.ptroot] run function emissive:_/light/passthrough/loop
