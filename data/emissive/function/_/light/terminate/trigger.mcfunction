...
execute if score *x _emissive matches 1 run return run execute unless score *terminate.nokill _emissive matches 1 run kill @s
...
execute unless score *terminate.nokill _emissive matches 1 run kill @s