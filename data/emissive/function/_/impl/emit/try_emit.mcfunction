...
execute as @e[type=marker,tag=_emissive.light,distance=0..0.1] unless score @s _emissive.self = *self _emissive if score @s _emissive.emitting >= *emit.level _emissive run return 1
